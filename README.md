...
To run the automated tests using Playwright, use the following command:

To run the automated tests using Selenium WebDriver, execute the test suite using your preferred test runner or IDE configured with JUnit/TestNG.
